...
>
    ...
    >
        <div class="absolute inset-0 bg-brand-teal/60"></div>
    </div>

    <div
        x-show="show"
        class="relative z-10 mb-6 rounded-2xl border border-slate-200 bg-white shadow-xl transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH F:\Work Area\Projects\Mood-Abaya\laravel\resources\views\components\modal.blade.php ENDPATH**/ ?>
            ...
            <?php if($payment->proof_path): ?>
                <?php $__env->startComponent('components.admin.card', ['title' => __('Proof')]); ?>
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="<?php echo e(\Illuminate\Support\Facades\Storage::url($payment->proof_path)); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-1 text-sm font-medium text-brand-teal hover:text-brand-teal-dark">

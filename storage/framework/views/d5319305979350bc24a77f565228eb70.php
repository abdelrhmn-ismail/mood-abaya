...
<?php $component->withAttributes([]); ?>
    <h1 class="text-2xl font-bold text-slate-900"><?php echo e(__('Register')); ?></h1>
    <p class="mt-1 text-sm text-slate-600"><?php echo e(__('Create your account')); ?></p>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex flex-col gap-4 pt-2 sm:flex-row sm:items-center sm:justify-between">
            <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-slate-600 hover:text-slate-900 transition">
...
<?php endif; ?>
<?php /**PATH F:\Work Area\Projects\Mood-Abaya\laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>
                ...
                <?php $__env->startComponent('components.admin.card', ['title' => __('Payment')]); ?>
                    ...
                    <?php if($payment->method === 'bank' && $payment->status === 'pending_approval'): ?>
                        <?php if($payment->proof_path): ?>
                            <p class="mt-3">
                                <a href="<?php echo e(\Illuminate\Support\Facades\Storage::url($payment->proof_path)); ?>" target="_blank" class="inline-flex items-center gap-1 text-sm text-brand-teal hover:text-brand-teal-dark">

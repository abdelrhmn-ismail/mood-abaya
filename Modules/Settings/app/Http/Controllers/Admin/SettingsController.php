...
use Modules\Settings\Http\Requests\Admin\UpdateFrontendSettingsRequest;
use Modules\Settings\Http\Requests\Admin\UpdateSettingsRequest;
use Modules\Settings\Http\Requests\Admin\UpdateTranslationsRequest;
use Modules\Settings\Services\Admin\SettingsService;
...
class SettingsController
{
    ...
    public function edit(SettingsService $settingsService): View
    {
        ...
        return view('settings::admin.edit', compact('settings'));
    }
    ...
    public function translations(SettingsService $settingsService): View
    {
        ...
        return view('settings::admin.translations', compact('translations'));
    }
    ...
    public function frontend(SettingsService $settingsService): View
    {
        ...
        return view('settings::admin.frontend', compact('settings'));
    }

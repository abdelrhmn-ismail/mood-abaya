...
<div class="space-y-6">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        {{-- Payment details --}}
        @component('admin::components.card', ['title' => __('Payment details')])
            <div class="space-y-4">
        ...
        <div class="space-y-6">
            @if($payment->proof_path)
                @component('admin::components.card', ['title' => __('Proof')])
                    <div class="flex items-start gap-3">
            ...
            @component('admin::components.card', ['title' => __('Actions')])

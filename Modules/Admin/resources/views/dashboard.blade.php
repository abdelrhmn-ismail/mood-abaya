...
<div class="space-y-8">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        ...
        @component('admin::components.card', ['title' => __('Orders this week') . ' – ' . __('Last 7 days')])
        ...
        {{-- Low stock --}}
        @component('admin::components.card', ['title' => __('Low stock alerts')])
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        {{-- Top products --}}
        @component('admin::components.card', ['title' => __('Top products')])
        ...
        {{-- Recent orders --}}
        @component('admin::components.card', ['title' => __('Recent orders')])

...
use Modules\Testimonial\Http\Requests\Admin\StoreTestimonialRequest;
use Modules\Testimonial\Services\Admin\TestimonialService;
...
class TestimonialController
{
    ...
    public function create(): View
    {
        ...
        return view('testimonial::admin.create', compact('testimonial'));
    }

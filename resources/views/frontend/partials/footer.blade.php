                ...
                @if($hasSocial)
                    <div class="mt-4 flex flex-wrap gap-2">
                        @if(site_whatsapp_url())
                            <a href="{{ site_whatsapp_url() }}" target="_blank" rel="noopener noreferrer" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-green-500 hover:scale-110" aria-label="WhatsApp">
                        ...
                        @if(site_instagram_url())
                            <a href="{{ site_instagram_url() }}" target="_blank" rel="noopener noreferrer" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-amber-500 hover:scale-110" aria-label="Instagram">
                        ...
                        @if(site_facebook_url())
                            <a href="{{ site_facebook_url() }}" target="_blank" rel="noopener noreferrer" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-[#1877f2] hover:scale-110" aria-label="Facebook">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                        @endif
                        @if(site_twitter_url())
                            <a href="{{ site_twitter_url() }}" target="_blank" rel="noopener noreferrer" class="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-[#1da1f2] hover:scale-110" aria-label="Twitter">
